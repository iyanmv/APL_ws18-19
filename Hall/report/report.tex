...
\end{equation}Where $\mu$ is the \emph{mobility} we are looking for. %In our case the electric field will be parallel to the surface of the sample and the magnetic field orthogonal, hence we can remove the vectors.
