...
Firstly we used a \emph{calibration sample} with a known surface in order to test the tip and the software used to obtain our data. This sample had 6 different surfaces. We fixed the sample in the centre of the AFM and used the camera installed inside our Nanosurf NaioAFM equipment to individuate the different surfaces.
...
\caption{Picture of sample 2 from the cmera installed in Nanosurf NaioAFM}\label{fig:sample2_set}
\end{center}
\end{figure}
...
We can observe that the plot reminds a set of Stars of David. Moreover, we can see that the surface outside this plot is flat compared to the edges of the star.
