...
\maketitle
	...
	\begin{equation}
	\theta_F=lBVcos\phi
\end{equation}	 where $V$ is called Verdet constant.
...
\delta=C2\pi L B^2
\end{equation}
where $C=C(\lambda,T)$ is the \emph{Cotton-Mouton constant}.
