...
W_{CM}(\theta_{CM})=e^{-i\frac{\Delta n}{2}}
\begin{pmatrix}
1 & 0 \\
0 & 1
\end{pmatrix}
...
If $\theta_F=0$ and $\Delta n$ we see that:

\begin{equation*}
J_f=A\,W_{CM}(0)\,W_{\lambda/4}(\varphi=45^\circ)\,J_0=
\begin{pmatrix}
0\\0
\end{pmatrix}
\end{equation*}
